...
def main():
    ...
    copyfile('A1_PotionsChest_V1.esp.yaml', 'ar/Data Files/A1_PotionsChest_V1.esp.yaml')
    ...
    merge_mwse_scripts('ar/Data Files/A1_PotionsChest_V1.esp.yaml')
    write_records_count('ar/Data Files/A1_PotionsChest_V1.esp.yaml')
    ...
    merge_mwse_scripts('ar/Data Files/A1_Alchemy_V7_Apparatus.esp.yaml')
    write_records_count('ar/Data Files/A1_Alchemy_V7_Apparatus.esp.yaml')
    merge_mwse_scripts('ar/Data Files/A1_Alchemy_V7_Apparatus_MFR.esp.yaml')
    write_records_count('ar/Data Files/A1_Alchemy_V7_Apparatus_MFR.esp.yaml')
    ...
    assembly_plugin('ar/Data Files/A1_PotionsChest_V1.esp', 2012, 2, 14, 18, 53, 0)
